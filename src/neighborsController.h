...
extern recent_neighbors* search_id_RN(recent_neighbors *list,uint64_t id,recent_neighbors **current,recent_neighbors **precedent);
...
extern potential_neighbors* search_id_PN(uint64_t id,potential_neighbors **current,potential_neighbors **precedent);
extern potential_neighbors* search_key_PN(uint64_t id,ip_port* key,ip_port **current,ip_port **precedent);
